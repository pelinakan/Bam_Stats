...
static int
lc_extrap(string outfile, string input_file ) {
  ...
  try {
    ...
    bool SINGLE_ESTIMATE = true;
    bool DEFECTS = false;
      
//#ifdef HAVE_SAMTOOLS
    bool BAM_FORMAT_INPUT = true;
...
//#endif
    ...
    const string input_file_name = leftover_args.front();
      */
    /******************************************************************/
const string input_file_name = input_file.c_str();
...
int
preseq(const int argc, const char **argv) {
